...
public static class LexerRules
{
    ...
    [
        ...
        LexerRule.MultiCharacter(SyntaxKind.SlashSlash, "//"),
        LexerRule.MultiCharacter(SyntaxKind.SlashSlashEquals, "//="),
        ...
        LexerRule.SingleCharacter(SyntaxKind.Tilde, '~'),
        LexerRule.MultiCharacter(SyntaxKind.TildeEquals, "~="),
